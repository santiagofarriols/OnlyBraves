...
function Desafia() {
  ...
  return (
    <div className="flex h-screen bg-cover bg-center justify-center items-center overflow-hidden " style={{ backgroundImage: `url(${bg1})` , backgroundAttachment: 'fixed', overflow: 'hidden' }}>
